...
public class SettingsView: UIView {
	...
	public let exitButton = CornerView(UIButton())
	...
	public let personAvatarView = UIImageView()
		|> \.clipsToBounds .~ true
		|> \.contentMode .~ .scaleAspectFill
	
	public let tableView = UITableView()
	public let bottomBarLayout = UILayoutGuide()
	public let footerBarLayout = UILayoutGuide()
