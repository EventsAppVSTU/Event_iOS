...
public class AuthView: UIView {
	...
	public lazy private(set) var credentialsView =
	...
	override public init(frame: CGRect) {
		...
		[credentialsView, brandStackView, registrationButton, backgroundView]
			.forEach { $0.translatesAutoresizingMaskIntoConstraints = false }

        insertSubview(credentialsView, at: 1)
        ...
        NSLayoutConstraint.activate([
			...
			footerLayoutGuide.bottomAnchor.constraint(equalTo: self.credentialsView.topAnchor),
            ...
            credentialsView.centerYAnchor.constraint(equalTo: centerYAnchor),
            credentialsView.leftAnchor.constraint(equalTo: leftAnchor, constant: 20),
            credentialsView.rightAnchor.constraint(equalTo: rightAnchor, constant: -20),
